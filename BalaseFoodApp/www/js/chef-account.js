$(document).ready(function () {
    ...
    function fetchAccountDetails() {
        ...
        $.ajax({
            type: 'GET',
           url: 'https://balasefoodorderingsystem.muccs.host/php/fetch_chef_details',
            dataType: 'json',
            data: { user_id: user_id }, // Pass user_id as a parameter
    ...
    $('#account-form').on('submit', function(event) {
        ...
        // Add user_id from getCookie function to the data object
